...
public class SurveyService {
	// create array list of surveys from Survey model
  ...
  // create array of questions and adding individual question into it
		List<Question> questions = new ArrayList<>(Arrays.asList(question1,
				question2, question3, question4));
     // create individual survey
		Survey survey = new Survey("Survey1", "My Favorite Survey",
				"Description of the Survey", questions);
 // add each survey to array surveys that we created above
		surveys.add(survey);
	}
